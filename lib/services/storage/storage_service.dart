...
/// StorageService provides a clean interface to Hive boxes.
/// Note: Hive must be initialized in main.dart before using this service.
class StorageService {
  static final StorageService _instance = StorageService._internal();
  factory StorageService() => _instance;
  StorageService._internal();
  
  /// Access daily data box (must be opened in main.dart)
  ...
  /// Access settings box (must be opened in main.dart)
  ...
  /// Access options box (must be opened in main.dart)
  ...
  int getMenstrualDays({int defaultValue = 7}) {
    return settingsBox.get(StorageKeys.menstrualDays, defaultValue: defaultValue) ?? defaultValue;
  }

...
class _CycleTrackerState extends State<CycleTracker> {
  ...
  final bool _hasMoodEntries = false;
  DateTime? _periodRangeStart;
  ...
  List<DateTime> _getFertileDates(DateTime periodStart) {
    final cycleLength = _calculateCycleStats()['average'] ?? 28;
...
// Update the cycle stats calculation
  ...
  void _showDailyLog(DateTime initialDate) {
    ...
    final data = _getDailyData(initialDate);
  ...
  Widget _buildPhaseExpansionTile(PhaseDetail phase) {
    ...
    return ExpansionTile(
      ...
      trailing: Chip(
        ...
        backgroundColor: _getPhaseColor(phase.name).withOpacity(0.1),
      ),
      children: [
        Padding(
            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 16),
                  Text(
                    isCurrent ? '$daysRemaining days left' : 'Completed',
                    style: TextStyle(
                      color: Colors.grey[600],
                      fontSize: 12,
                    ),
  ...
  double _calculateConsistency(List<int> cycleLengths) {
    final average = cycleLengths.reduce((a, b) => a + b) / cycleLengths.length;
    ...
    return (100 - (averageDifference / average * 100)).clamp(0, 100);
  }
  ...
  String _getPhaseDescription(String phase) {
    switch (phase) {
      ...
      case '🌱 Follicular':
        return 'Increased energy and creativity';
      case '🌕 Ovulation':
        return 'Peak energy and social engagement';
      case '🍂 Luteal':
        return 'Time for reflection and planning';
      default:
      ...
      child: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Colors.white, Color.fromARGB(255, 255, 98, 150)],
          ),
        ),
        child: Column(
          children: [
      ...
      child: Container(
        ...
        child: Column(
          children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: prediction != null ? Colors.pink : Colors.grey,
                        ),
                      ),
                    ],
                  ),
            ...
            Text(
              periods.isEmpty
                  ? 'Track your period by tapping a date (or long-pressing to edit)'
                  : prediction != null
                      ? '${stats['average']} day cycle average'
